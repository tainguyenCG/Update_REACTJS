      ...
      <div className="flex items-center max-w-3xl p-5 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl">
        <div className="px-8 md:w-1/2">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            <input
              className="p-2 mt-8 border rounded-xl placeholder:text-gray-700 font-medium"
              type="email"
              name="email"
              placeholder="Email"
              value={email}
            ...
            <div className="relative">
              <input
                className="w-full p-2 pr-10 border rounded-xl placeholder:text-gray-700 font-medium"
